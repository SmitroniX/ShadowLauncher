...
import com.shadowlauncher.tasks.AsyncAssetManager;
import com.shadowlauncher.utils.*;
import com.shadowlauncher.utils.FileUtils;

public class ShadowApplication extends Application {
	public static final String CRASH_REPORT_TAG = "ShadowCrashReport";
	...
	public void onCreate() {
		...
		Thread.setDefaultUncaughtExceptionHandler((thread, th) -> {
			boolean storagePermAllowed = (Build.VERSION.SDK_INT < 23 || Build.VERSION.SDK_INT >= 29 ||
					ActivityCompat.checkSelfPermission(ShadowApplication.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) && Tools.checkStorageRoot(ShadowApplication.this);
			...
			try {
				...
				crashStream.append("ShadowLauncher crash report\n");
			...
			FatalErrorActivity.showError(ShadowApplication.this, crashFile.getAbsolutePath(), storagePermAllowed, th);
			Tools.fullyExit();
		});
