...
import com.shadowlauncher.modloaders.FabriclikeDownloadTask;
import com.shadowlauncher.modloaders.FabriclikeUtils;
import com.shadowlauncher.modloaders.FabricVersion;
import com.shadowlauncher.modloaders.ModloaderDownloadListener;
import com.shadowlauncher.modloaders.ModloaderListenerProxy;
import com.shadowlauncher.modloaders.modpacks.SelfReferencingFuture;
...
public abstract class FabriclikeInstallFragment extends Fragment implements ModloaderDownloadListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void updateLoaderVersions() {
        startLoading();
        mLoaderVersionFuture = new SelfReferencingFuture(new LoadLoaderVersionsTask()).startOnExecutor(ShadowApplication.sExecutorService);
    }
    ...
    private void updateGameVersions() {
        startLoading();
        mGameVersionFuture = new SelfReferencingFuture(new LoadGameVersionsTask()).startOnExecutor(ShadowApplication.sExecutorService);
    }
