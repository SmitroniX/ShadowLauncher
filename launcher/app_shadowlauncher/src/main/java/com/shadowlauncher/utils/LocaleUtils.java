...
import static com.shadowlauncher.prefs.LauncherPreferences.DEFAULT_PREF;
import static com.shadowlauncher.prefs.LauncherPreferences.PREF_FORCE_ENGLISH;
...
public class LocaleUtils extends ContextWrapper {
    ...
    public static ContextWrapper setLocale(Context context) {
        if (DEFAULT_PREF == null) {
            ...
            // Too early to initialize all prefs here, as this is called by ShadowApplication
