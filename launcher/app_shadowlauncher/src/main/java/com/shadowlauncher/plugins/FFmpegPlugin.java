package com.shadowlauncher.plugins;
...
public class FFmpegPlugin {
    ...
    public static void discover(Context context) {
        ...
        try {
            PackageInfo ffmpegPluginInfo = manager.getPackageInfo("com.shadowlauncher.ffmpeg", PackageManager.GET_SHARED_LIBRARY_FILES);
